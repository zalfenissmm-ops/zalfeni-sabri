...
## استراتيجية الفيديو — SMC_VIDEO_STRATEGY.md

تفريغ حرفي للاستراتيجية كما وردت في فيديو قناة *TREND is your friend*:
الشروط (سيولة → CHoCH → OB + FVG)، إعدادات الفيبوناتشي بالضبط (‎62% / 70.5% / 79%‎)،
حالتَا الدخول، ووقف الخسارة والهدف، مع أرقام المثال الحي على ‎S&P 500‎ فريم ‎5‎ دقائق.

> ملاحظة: `smc_strategy.py` الحالي يستعمل **منتصف الموجة (50% equilibrium)** لتحديد منطقة
> العلاوة/الخصم، بينما الفيديو يستعمل **المنطقة الذهبية ‎62%–79%‎ مع الدخول عند ‎70.5%‎**
> وهدفاً ثابتاً عند القمة السابقة. راجع `SMC_VIDEO_STRATEGY.md` للتفاصيل.
