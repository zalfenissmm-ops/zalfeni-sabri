...
## مؤشر MT5 — ستراتيجية الفيديو | mt5/SMC_VideoStrategy.mq5

مؤشر MetaTrader 5 يطبّق ستراتيجية الفيديو بالضبط ويرسمها على الشارت:

1. **فجوة سعرية (FVG)** — عدم توازن على ٣ شمعات، تتبقى مرسومة حتى تتعمّر.
2. **سيولة (LQ)** — كنس آخر قاع/قمّة مؤكّدة مع دخول الويك جوّة الفجوة.
3. **كسر هيكلي (BOS)** — آخر قمّة/قاع = الهدف، والدخول يتأكّد بإعادة استرجاع مستوى السيولة.

كي تتحقّق الشروط الثلاثة يرسم الصفقة كاملة (Entry / SL / TP #1 / TP) بمربّع أخضر للهدف
ومربّع أحمر للمخاطرة، مع نتيجة الصفقة بالـ pips. يخدم على كل الأزواج وكل الفريمات.

التفاصيل والإعدادات: [`mt5/README.md`](mt5/README.md)
